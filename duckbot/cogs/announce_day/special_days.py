...
class SpecialDays(holidays.Canada):
    ...
    def _populate(self, year):
        ...
        self[date(year, 10, 11)] = "Leif Erikson Day. Hinga Dinga Durgen! https://tenor.com/view/viking-spongebob-squarepants-durgen-fall-down-hard-gif-7302846 "  # intentional trailing space
