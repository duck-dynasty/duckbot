...
class SpecialDays(CA):
    ...
    def _populate(self, year):
        ...
        self[date(year, 8, 10)] = f"Dave and Sabrina's wedding anniversary. It's been {year-1991} years since he finally put a ring on it"
        ...
        self[date(year, 10, 21)] = f"G-dawg's birthday. He didn't want us knowing his birthday, but here we are. The {year-1988} year old is mad"
