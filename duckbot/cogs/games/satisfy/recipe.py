...
def regular() -> List[Recipe]:
    return [
        ...
        assy(Item.GasNobelisk, Item.Nobelisk * 5 + Item.Biomass * 50 >> Item.GasNobelisk * 5),
        ...
        manu(f"{Item.TurboRifleAmmo}#Manufacturer", Item.RifleAmmo * 120 + Item.AluminumCasing * 15 + Item.PackagedTurbofuel * 15 >> Item.TurboRifleAmmo * 250),
        blend(f"{Item.TurboRifleAmmo}#Blender", Item.RifleAmmo * 120 + Item.AluminumCasing * 15 + Item.Turbofuel * 15 >> Item.TurboRifleAmmo * 250),
